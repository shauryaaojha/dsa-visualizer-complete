...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-secondary/50 backdrop-blur-sm p-1.5 text-muted-foreground border border-primary/10",
      className
    )}
    {...props}
  />
